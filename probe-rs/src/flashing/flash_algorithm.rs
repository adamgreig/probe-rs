...
impl FlashAlgorithm {
    ...
    const ARM_FLASH_BLOB_HEADER_BKPT_T2_LE: [u32; 1] = [arm::assembly::BKPT_T2];
    const ARM_FLASH_BLOB_HEADER_BKPT_T2_BE: [u32; 1] = [arm::assembly::BKPT_T2.swap_bytes()];
    ...
    fn algorithm_header(core_type: CoreType, endian: Endian) -> &'static [u32] {
        match core_type {
            ...
            | CoreType::Armv7m
            | CoreType::Armv7em
            | CoreType::Armv8m => match endian {
                Endian::Little => &Self::ARM_FLASH_BLOB_HEADER_BKPT_T2_LE,
                Endian::Big => &Self::ARM_FLASH_BLOB_HEADER_BKPT_T2_BE,
            },
